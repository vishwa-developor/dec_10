...
if(isset($_POST['track']))
{
    ...
    $o_id=$_POST['orderId'];
	$track_sql = "SELECT order_id,prdt_id,prdt_price,cust_name,cust_mail,
	del_agent_id,del_agent_number,order_destination,ordered_date,expected_delivery,expiry_date,status FROM orders_db 
	where order_id='$o_id'";
  
    $result=mysqli_query($con,$track_sql);
}
?>
<!DOCTYPE html>
<html>
	...
	<div class="container">
		<div class="box">
			...
			<div class="link-right">
				<a href="invdashboard.php" class="button-create">Back</a>
			</div>
