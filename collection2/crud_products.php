						...
						<?php
							...
							while($row = $query->fetch_assoc()){
								...
								"<tr>
									...
									<td>".$row['p_damaged']."</td>
									<td>".$row['p_perishable']."</td>
                                    <td>".$row['p_date_in']."</td>
									<td>".$row['p_price_per_item']."</td>
                                    <td>".$row['p_available']."</td>
									<td>".$row['p_expiry_date']."</td>
									

									<td>
										<a href='#edit_".$row['p_id']."' class='btn btn-success btn-sm' data-toggle='modal'><span class='glyphicon glyphicon-edit'></span> Edit</a>
										<a href='#delete_".$row['p_id']."' class='btn btn-danger btn-sm' data-toggle='modal'><span class='glyphicon glyphicon-trash'></span> Delete</a>
									</td>
								</tr>";
